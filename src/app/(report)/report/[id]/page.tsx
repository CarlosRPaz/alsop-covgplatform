        ...
        <div className={styles.container}>
            ...
            <div className={styles.document}>
                ...
                <div className={styles.footer}>
                    <div className={styles.footerBrand}>CoverageCheckNow · Comprehensive Policy Review</div>
