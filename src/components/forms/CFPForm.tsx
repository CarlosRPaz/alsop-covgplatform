                    ...
                    {!isAgent && (
                        <div className={styles.termsSection}>
                            ...
                            <div className={styles.termsContent}>
                                ...
                                Submitting a document or receiving a coverage review report does <strong>NOT</strong> modify, amend, bind, cancel, or reinstate any insurance policy contract. Coverage changes or new policy placements can ONLY be bound upon explicit written confirmation from a licensed insurance producer / agent of record. The official insurance policy contract issued by your insurance carrier (including the California FAIR Plan or companion Difference in Conditions carriers) remains the sole governing legal agreement defining your coverage, terms, limits, and exclusions.</p>

                                <p><strong>3. California FAIR Plan &amp; Companion DIC Notice</strong><br />
                                California FAIR Plan policies provide named peril coverage (primarily fire, lightning, internal explosion, and smoke) and do <strong>NOT</strong> cover water damage, theft, general liability, earthquake, or flood hazards without a separate Companion Difference in Conditions (DIC) or specialty policy. Recommendations generated by CoverageCheckNow are based solely on documents uploaded and third-party data available at the time of review.</p>
